import { getDescription, StringValueNode, TypeDefinitionNode, DocumentNode, ASTNode, NameNode, TypeNode, visit, VisitFn } from 'graphql';
...
export function pushComment(node: { readonly description?: StringValueNode }, entity: string, field?: string): void {
  ...
  const path = (field ? [entity, field] : [entity]).join('.');
